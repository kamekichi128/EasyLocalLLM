...
- [4. 使用方法](#4-使用方法)
  ...
  - [4.6 Ollama サーバの自動管理](#46-ollama-サーバの自動管理)
  - [4.7 セッション管理](#47-セッション管理)
  - [4.8 システムプロンプト](#48-システムプロンプト)
  - [4.9 優先度スケジューリング](#49-優先度スケジューリング)
  - [4.10 キャンセル](#410-キャンセル)
  - [4.11 リトライとエラーハンドリング](#411-リトライとエラーハンドリング)
  - [4.12 メッセージ永続化](#412-メッセージ永続化)
  - [4.13 ツール（Function Calling）](#413-ツールfunction-calling)
  - [4.14 JSON形式のレスポンス指定](#414-json形式のレスポンス指定)
- [5. 実践例](#5-実践例)
- [6. クラス構成](#6-クラス構成)
- [7. 設定オプション](#7-設定オプション)
...
**Ollama のセットアップが未完了の場合は、[4.6 Ollama サーバの自動管理](#46-ollama-サーバの自動管理)を参照してください。**
