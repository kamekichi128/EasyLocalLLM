...
- [4. 使用方法](#4-使用方法)
  ...
  - [4.5 Ollama サーバの自動管理](#45-ollama-サーバの自動管理)
  - [4.6 セッション管理](#46-セッション管理)
  - [4.7 システムプロンプト](#47-システムプロンプト)
  - [4.8 優先度スケジューリング](#48-優先度スケジューリング)
  - [4.9 キャンセル](#49-キャンセル)
  - [4.10 リトライとエラーハンドリング](#410-リトライとエラーハンドリング)
  - [4.11 メッセージ永続化](#411-メッセージ永続化)
  - [4.12 ツール（Function Calling）](#412-ツールfunction-calling)
  - [4.13 JSON形式のレスポンス指定](#413-json形式のレスポンス指定)
- [5. 実践例](#5-実践例)
- [6. クラス構成](#6-クラス構成)
- [7. 設定オプション](#7-設定オプション)
...
**Ollama のセットアップが未完了の場合は、[4.5 Ollama サーバの自動管理](#45-ollama-サーバの自動管理)を参照してください。**
